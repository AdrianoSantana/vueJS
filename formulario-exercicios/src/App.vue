		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Prioridade">
					<select name="" id="" v-model="prioridadeEscolhida">
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<span>
						<ul>
							<li v-for="valor in caracteristicas" :key="valor">{{ valor }}</li>
						</ul>
					</span>
				</Rotulo>
				<Rotulo nome="Qual produto?">
				...
				<Rotulo nome="Prioridade">
					<span>{{ prioridadeEscolhida }}</span>
				</Rotulo>
				<Rotulo nome="Primeira Reclamação?">
					<span>{{ ligado }}</span>
				</Rotulo>
				<Rotulo nome="Temp">{{ temp }}</Rotulo>
			</div>
		</div>
	</div>
</template>
